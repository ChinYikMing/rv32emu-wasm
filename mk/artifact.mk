...
ifeq ($(call has, PREBUILT), 1)
	...
	$(eval PREBUILT_BLOB_URL := https://github.com/sysprog21/rv32emu-prebuilt/releases/download/$(Linux_LATEST_RELEASE))
    else ifeq ($(call has, ARCH_TEST), 1)
        #$(call fetch-releases-tag,sail,rv32emu-prebuilt-sail-$(HOST_PLATFORM),Sail model)
	$(eval PREBUILT_BLOB_URL := https://github.com/sysprog21/rv32emu-prebuilt/releases/download/$(Sail_LATEST_RELEASE))
    else
        #$(call fetch-releases-tag,ELF,rv32emu-prebuilt.tar.gz,Prebuilt benchmark)
	$(eval PREBUILT_BLOB_URL := https://github.com/sysprog21/rv32emu-prebuilt/releases/download/$(ELF_LATEST_RELEASE))
    endif
else
